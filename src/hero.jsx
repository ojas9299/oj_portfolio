...
export default function MyHero() {
  ...
  return (
    <>
<<<<<<< HEAD
      <div className="h-[100vh] realtive">
        <img
        ...
        />
        <div>
          <p className="hero-text absolute text-[50px] lg:text-[70px] lg:top-36 top-44 left-12 lg:left-48  text-white tracking-widest">
            Ojas
          </p>
          <p className="hero-text absolute top-60 text-[50px] lg:text-[70px] left-12 lg:left-48  text-white">
            Bhalerao
          </p>
          <p className="hero-text absolute top-[310px] lg:top-[330px] left-12 lg:left-48  text-white tracking-wider hvr-underline-from-left">
            FullStack Developer
          </p>
        </div>
        <div className="absolute top-96 left-12 text-white lg:left-48">
=======
